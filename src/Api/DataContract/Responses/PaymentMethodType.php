...
class PaymentMethodType
{
    ...
    /**
     * @var \Icepay\Api\DataContract\Responses\IssuerType[]|null
     */
     ...
     * Gets the Issuers.
     *
     * @return \Icepay\Api\DataContract\Responses\IssuerType[]|null
     */
     ...
     * Sets the Issuers.
     *
     * @param \Icepay\Api\DataContract\Responses\IssuerType[]|null $Issuers
     * @return $this
     */
     ...
     * Adds an Issuer.
     *
     * @param \Icepay\Api\DataContract\Responses\IssuerType $Issuer The Issuer to add.
     * @return $this
     */
    public function addIssuer(\Icepay\Api\DataContract\Responses\IssuerType $Issuer)
    {
        $this->Issuers[] = $Issuer;
        return $this;
    }
     ...
     * @param \Icepay\Api\DataContract\Responses\IssuerType $Issuer The Issuer to set.
     * @return $this
     */
    public function setIssuer($key, \Icepay\Api\DataContract\Responses\IssuerType $Issuer)
    {
     ...
     * @return \Icepay\Api\DataContract\Responses\IssuerType|null The removed Issuer or NULL.
     */
     ...
     * Removes the Issuer at the specified key/index.
     *
     * @param \Icepay\Api\DataContract\Responses\IssuerType $Issuer The Issuer to search for.
