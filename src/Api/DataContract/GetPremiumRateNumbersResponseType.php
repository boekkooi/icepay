...
class GetPremiumRateNumbersResponseType extends BaseTypeType
{
    ...
    /**
     * @var \Icepay\Api\DataContract\PremiumRateNumberInformationType[]|null
     */
     ...
     *
     * @return \Icepay\Api\DataContract\PremiumRateNumberInformationType[]|null
     */
     ...
     *
     * @param \Icepay\Api\DataContract\PremiumRateNumberInformationType[]|null $PremiumRateNumbers
     * @return $this
     */
     ...
     *
     * @param \Icepay\Api\DataContract\PremiumRateNumberInformationType $PremiumRateNumber The PremiumRateNumber to add.
     * @return $this
     */
    public function addPremiumRateNumber(\Icepay\Api\DataContract\PremiumRateNumberInformationType $PremiumRateNumber)
    {
     ...
     * @param \Icepay\Api\DataContract\PremiumRateNumberInformationType $PremiumRateNumber The PremiumRateNumber to set.
     * @return $this
     */
    public function setPremiumRateNumber($key, \Icepay\Api\DataContract\PremiumRateNumberInformationType $PremiumRateNumber)
    {
     ...
     * @return \Icepay\Api\DataContract\PremiumRateNumberInformationType|null The removed PremiumRateNumber or NULL.
     */
     ...
     * Removes the PremiumRateNumber at the specified key/index.
     *
     * @param \Icepay\Api\DataContract\PremiumRateNumberInformationType $PremiumRateNumber The PremiumRateNumber to search for.
