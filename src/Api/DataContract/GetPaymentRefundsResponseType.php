...
class GetPaymentRefundsResponseType
{
    ...
    /**
     * @var \Icepay\Api\DataContract\SharedResponse\RefundType[]|null
     */
     ...
     * Gets the Refunds.
     *
     * @return \Icepay\Api\DataContract\SharedResponse\RefundType[]|null
     */
     ...
     * Sets the Refunds.
     *
     * @param \Icepay\Api\DataContract\SharedResponse\RefundType[]|null $Refunds
     * @return $this
     */
     ...
     * Adds an Refund.
     *
     * @param \Icepay\Api\DataContract\SharedResponse\RefundType $Refund The Refund to add.
     * @return $this
     */
    public function addRefund(\Icepay\Api\DataContract\SharedResponse\RefundType $Refund)
    {
        $this->Refunds[] = $Refund;
        return $this;
    }
     ...
     * @param \Icepay\Api\DataContract\SharedResponse\RefundType $Refund The Refund to set.
     * @return $this
     */
    public function setRefund($key, \Icepay\Api\DataContract\SharedResponse\RefundType $Refund)
    {
     ...
     * @return \Icepay\Api\DataContract\SharedResponse\RefundType|null The removed Refund or NULL.
     */
     ...
     * Removes the Refund at the specified key/index.
     *
     * @param \Icepay\Api\DataContract\SharedResponse\RefundType $Refund The Refund to search for.
