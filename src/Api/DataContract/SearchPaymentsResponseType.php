...
class SearchPaymentsResponseType
{
    ...
    /**
     * @var \Icepay\Api\DataContract\SharedResponse\PaymentType[]|null
     */
     ...
     * Gets the Payments.
     *
     * @return \Icepay\Api\DataContract\SharedResponse\PaymentType[]|null
     */
     ...
     * Sets the Payments.
     *
     * @param \Icepay\Api\DataContract\SharedResponse\PaymentType[]|null $Payments
     * @return $this
     */
     ...
     * Adds an Payment.
     *
     * @param \Icepay\Api\DataContract\SharedResponse\PaymentType $Payment The Payment to add.
     * @return $this
     */
    public function addPayment(\Icepay\Api\DataContract\SharedResponse\PaymentType $Payment)
    {
     ...
     * @param \Icepay\Api\DataContract\SharedResponse\PaymentType $Payment The Payment to set.
     * @return $this
     */
    public function setPayment($key, \Icepay\Api\DataContract\SharedResponse\PaymentType $Payment)
    {
     ...
     * @return \Icepay\Api\DataContract\SharedResponse\PaymentType|null The removed Payment or NULL.
     */
     ...
     * Removes the Payment at the specified key/index.
     *
     * @param \Icepay\Api\DataContract\SharedResponse\PaymentType $Payment The Payment to search for.
