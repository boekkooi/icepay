...
class GetMyPaymentMethodResponseType
{
    ...
    /**
     * @var \Icepay\Api\DataContract\Responses\PaymentMethodType[]|null
     */
     ...
     *
     * @return \Icepay\Api\DataContract\Responses\PaymentMethodType[]|null
     */
     ...
     *
     * @param \Icepay\Api\DataContract\Responses\PaymentMethodType[]|null $PaymentMethods
     * @return $this
     */
     ...
     *
     * @param \Icepay\Api\DataContract\Responses\PaymentMethodType $PaymentMethod The PaymentMethod to add.
     * @return $this
     */
    public function addPaymentMethod(\Icepay\Api\DataContract\Responses\PaymentMethodType $PaymentMethod)
    {
     ...
     * @param \Icepay\Api\DataContract\Responses\PaymentMethodType $PaymentMethod The PaymentMethod to set.
     * @return $this
     */
    public function setPaymentMethod($key, \Icepay\Api\DataContract\Responses\PaymentMethodType $PaymentMethod)
    {
     ...
     * @return \Icepay\Api\DataContract\Responses\PaymentMethodType|null The removed PaymentMethod or NULL.
     */
     ...
     * Removes the PaymentMethod at the specified key/index.
     *
     * @param \Icepay\Api\DataContract\Responses\PaymentMethodType $PaymentMethod The PaymentMethod to search for.
