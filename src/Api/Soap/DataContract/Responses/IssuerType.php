...
class IssuerType
{
     ...
     * Sets the Countries.
     *
     * @param \Icepay\Api\Soap\DataContract\Responses\CountryType[]|null $Countries
     * @return $this
     */
     ...
     * Adds an Country.
     *
     * @param \Icepay\Api\Soap\DataContract\Responses\CountryType $Country The Country to add.
     * @return $this
     */
    public function addCountry(\Icepay\Api\Soap\DataContract\Responses\CountryType $Country)
    {
     ...
     * @param \Icepay\Api\Soap\DataContract\Responses\CountryType $Country The Country to set.
     * @return $this
     */
    public function setCountry($key, \Icepay\Api\Soap\DataContract\Responses\CountryType $Country)
    {
     ...
     * @return \Icepay\Api\Soap\DataContract\Responses\CountryType|null The removed Country or NULL.
     */
     ...
     * Removes the Country at the specified key/index.
     *
     * @param \Icepay\Api\Soap\DataContract\Responses\CountryType $Country The Country to search for.
