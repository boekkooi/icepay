...
class GetMerchantsResponseType
{
    ...
    /**
     * @var \Icepay\Api\Soap\DataContract\SharedResponse\MerchantType[]|null
     */
     ...
     * Gets the Merchants.
     *
     * @return \Icepay\Api\Soap\DataContract\SharedResponse\MerchantType[]|null
     */
     ...
     * Sets the Merchants.
     *
     * @param \Icepay\Api\Soap\DataContract\SharedResponse\MerchantType[]|null $Merchants
     * @return $this
     */
     ...
     * Adds an Merchant.
     *
     * @param \Icepay\Api\Soap\DataContract\SharedResponse\MerchantType $Merchant The Merchant to add.
     * @return $this
     */
    public function addMerchant(\Icepay\Api\Soap\DataContract\SharedResponse\MerchantType $Merchant)
    {
     ...
     * @param \Icepay\Api\Soap\DataContract\SharedResponse\MerchantType $Merchant The Merchant to set.
     * @return $this
     */
    public function setMerchant($key, \Icepay\Api\Soap\DataContract\SharedResponse\MerchantType $Merchant)
    {
     ...
     * @return \Icepay\Api\Soap\DataContract\SharedResponse\MerchantType|null The removed Merchant or NULL.
     */
     ...
     * Removes the Merchant at the specified key/index.
     *
     * @param \Icepay\Api\Soap\DataContract\SharedResponse\MerchantType $Merchant The Merchant to search for.
