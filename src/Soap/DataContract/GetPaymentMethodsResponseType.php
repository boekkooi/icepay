...
class GetPaymentMethodsResponseType
{
    ...
    /**
     * @var \Icepay\Api\Soap\DataContract\SharedResponse\PaymentMethodType[]|null
     */
     ...
     *
     * @return \Icepay\Api\Soap\DataContract\SharedResponse\PaymentMethodType[]|null
     */
     ...
     *
     * @param \Icepay\Api\Soap\DataContract\SharedResponse\PaymentMethodType[]|null $PaymentMethods
     * @return $this
     */
     ...
     *
     * @param \Icepay\Api\Soap\DataContract\SharedResponse\PaymentMethodType $PaymentMethod The PaymentMethod to add.
     * @return $this
     */
    public function addPaymentMethod(\Icepay\Api\Soap\DataContract\SharedResponse\PaymentMethodType $PaymentMethod)
    {
     ...
     * @param \Icepay\Api\Soap\DataContract\SharedResponse\PaymentMethodType $PaymentMethod The PaymentMethod to set.
     * @return $this
     */
    public function setPaymentMethod($key, \Icepay\Api\Soap\DataContract\SharedResponse\PaymentMethodType $PaymentMethod)
    {
     ...
     * @return \Icepay\Api\Soap\DataContract\SharedResponse\PaymentMethodType|null The removed PaymentMethod or NULL.
     */
     ...
     * Removes the PaymentMethod at the specified key/index.
     *
     * @param \Icepay\Api\Soap\DataContract\SharedResponse\PaymentMethodType $PaymentMethod The PaymentMethod to search for.
